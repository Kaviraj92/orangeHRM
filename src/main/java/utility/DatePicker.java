...
{
	String yyyymmdd[]=expdate.split("-");
	 String expDate=yyyymmdd[0];
	 int expMonth=Integer.parseInt(yyyymmdd[1]);
	 int expYear=Integer.parseInt(yyyymmdd[2]);
	
// Calendar Month and Year
     boolean dateNotFound=true;
//WebElements of date picker
	 driver.findElement(By.className("oxd-calendar-wrapper")).click();
...
//while loop to check the month and year
	    while(dateNotFound)
	    {
		    ...
		    WebElement picyear= driver.findElement(By.cssSelector("div.oxd-calendar-header>ul.oxd-calendar-selector>li.oxd-calendar-selector-year"));
